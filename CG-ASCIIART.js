...
// this display on a good old terminal? We have: with ASCII art!
...
// ​Your mission is to write a program that can display a line of 
// text in ASCII art in a style you are given as input.
...
// My Solution:
// **** Works only for test case -> one letter: 'E'
// **** Still working on test case -> 'MANHATTAN'
...
//         let id = splitT[j] * 4;
//         let answer = ROW[id] + ROW[id + 1] + ROW[id + 2] + ROW[id + 3];
//         console.log(answer);
//     }
// }
